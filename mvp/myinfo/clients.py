...
class MyInfoPersonalClientV4(MyInfoClient):
    ...
    def retrieve_resource(self, auth_code: str, state: str, callback_url: str) -> dict:
        ...
        response_token, error_token = self.get_access_token(
            auth_code=auth_code,
            state=state,
        ...
        response_person_data, error_person_data = self.get_person_data(access_token, session_ephemeral_keypair)

        return decrypt_jwe(response_person_data)
