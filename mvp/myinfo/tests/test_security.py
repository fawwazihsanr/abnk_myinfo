...
import responses
from django.conf import settings as myinfo_settings
from jwcrypto import jwk, jws
from mvp.myinfo.security import (
    decrypt_jwe,
...
class TestJWT(unittest.TestCase):
    ...
    @patch("mvp.myinfo.security.get_random_string")
    @patch("mvp.myinfo.security.time.time", return_value=1710202991.123456)
    @patch("mvp.myinfo.security.generate_ephemeral_session_keypair")
