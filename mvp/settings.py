"""
Django settings for abnk_assessment project.
...
SECRET_KEY = 'django-insecure-5y@5l6sw52-y+95uxd18kx57xy-@d*-6#4q1vr)8j@#bzg9qpl'
...
MYINFO_CLIENT_ID = os.environ.get('MYINFO_CLIENT_ID', 'STG-202327956K-ABNK-BNPLAPPLN')
